...
import kotlinx.android.synthetic.main.my_reacycle_item_layout.*
...
class MyRecycleAdapt(list: ArrayList<String>) : BaseRecycleAdapt<String>(list) {
    override fun createItem(parent: ViewGroup): View {
        return LayoutInflater.from(parent.context).inflate(R.layout.my_reacycle_item_layout, parent, false)
    }
