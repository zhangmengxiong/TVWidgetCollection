...
//        final int childTop = child.getTop() + rect.top - child.getScrollY();
        ...
        final int offScreenLeft = Math.min(0, childLeft - parentLeft - 300);
        final int offScreenTop = Math.min(0, childTop - parentTop - 300);
        final int offScreenRight = Math.max(0, childRight - parentRight + 300);
        final int offScreenBottom = Math.max(0, childBottom - parentBottom + 300);
